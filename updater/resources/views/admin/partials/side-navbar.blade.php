    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
                    ...
                    <div class="col-12">
                        <form action="">
                            <div class="form-group py-0">
                                <input type="hidden" name="language" value="{{ @$default->code }}" id="languageId">
                                <input name="term" type="text" class="form-control sidebar-search "
                                    value="" placeholder="{{ __('Search Menu Here')}}..." style="direction: {{ @$default->rtl == 0 ? 'ltr' : 'rtl' }};">
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <div class="collapse
                            ...
                            <ul class="nav nav-collapse">
                                ...
                                <li class="@if (request()->path() == 'admin/domains' && request()->input('type') == 'pending') active @endif">
                                    <a
                                        href="{{ route('admin.custom-domain.index', ['type' => 'pending', 'language' => $default->code]) }}">
                                ...
                                <li class="@if (request()->path() == 'admin/domains' && request()->input('type') == 'connected') active @endif">
                                    <a
                                        href="{{ route('admin.custom-domain.index', ['type' => 'connected', 'language' => $default->code]) }}">
                                ...
                                <li class="@if (request()->path() == 'admin/domains' && request()->input('type') == 'rejected') active @endif">
                                    <a
                                        href="{{ route('admin.custom-domain.index', ['type' => 'rejected', 'language' => $default->code]) }}">
                        ...
                        <div class="collapse
                            ...
                            <ul class="nav nav-collapse">
                                ...
                                <li class="@if (request()->path() == 'admin/subdomains' && request()->input('type') == 'pending') active @endif">
                                    <a
                                        href="{{ route('admin.subdomain.index', ['type' => 'pending', 'language' => $default->code]) }}">
                                ...
                                <li class="@if (request()->path() == 'admin/subdomains' && request()->input('type') == 'connected') active @endif">
                                    <a
                                        href="{{ route('admin.subdomain.index', ['type' => 'connected', 'language' => $default->code]) }}">
         ...
         @elseif (request()->routeIs('register.user.changePass')) active
          ...
          @if (request()->path() == 'admin/register/users') active
          @elseif(request()->is('admin/register/user/details/*')) active
          @elseif(request()->routeIs('admin.register.user.settings')) active
          @elseif(request()->routeIs('admin.register.user.vcard')) active
          @elseif(request()->routeIs('admin.register.user.cv')) active
          @elseif (request()->routeIs('register.user.changePass')) active @endif">
                        <a data-toggle="collapse" href="#registeredUser">
                            <i class="la flaticon-users"></i>
            ...
            @elseif(request()->routeIs('admin.register.user.settings')) show
            @elseif(request()->routeIs('admin.register.user.vcard')) show
            @elseif(request()->routeIs('admin.register.user.cv')) show
            @elseif (request()->routeIs('register.user.changePass')) show @endif"
                            id="registeredUser">
                            <ul class="nav nav-collapse">
                                <li class="@if (request()->routeIs('admin.register.user.settings')) active @endif">
                                    <a
                                        href="{{ route('admin.register.user.settings') . '?language=' . $default->code }}">
                                        <span class="sub-item">{{ __('Settings') }}</span>
                                    </a>
                                </li>

                                <li class="@if (request()->path() == 'admin/register/users') active @endif">
                                    <a href="{{ route('admin.register.user') . '?language=' . $default->code }}">
                                        <span class="sub-item">{{ __('Registered Users') }}</span>
                                    </a>
                                </li>
                                <li class="@if (request()->routeIs('admin.register.user.vcard')) active @endif">
                                    <a href="{{ route('admin.register.user.vcard') . '?language=' . $default->code }}">
                                        <span class="sub-item">{{ __('Users vCards') }}</span>
                                    </a>
                                </li>
                                <li class="@if (request()->routeIs('admin.register.user.cv')) active @endif">
                                    <a href="{{ route('admin.register.user.cv') . '?language=' . $default->code }}">
                                        <span class="sub-item">{{ __('User CVs') }}</span>
                                    </a>
                                </li>
                    ...
                    @elseif(request()->path() == 'admin/pushnotification/send') show @endif"
                            ...
                            <ul class="nav nav-collapse">
                                <li class="@if (request()->path() == 'admin/pushnotification/settings') active @endif">
                                    <a
                                        href="{{ route('admin.pushnotification.settings') . '?language=' . $default->code }}">
                                        <span class="sub-item">{{ __('Settings') }}</span>
                                    </a>
                                </li>
                                <li class="@if (request()->path() == 'admin/pushnotification/send') active @endif">
                                    <a
                                        href="{{ route('admin.pushnotification.send') . '?language=' . $default->code }}">
          ...
          @elseif (request()->routeIs('admin.edit_mail_template')) active @endif">
            ...
            @elseif (request()->routeIs('admin.edit_mail_template')) show @endif"
                                    ...
                                    <div class="collapse {{ request()->path() == 'admin/mail-from-admin' || request()->path() == 'admin/mail-to-admin' || request()->routeIs('admin.mail_templates') || request()->routeIs('admin.edit_mail_template') ? 'show' : '' }}"
                                        ...
                                        <ul class="nav nav-collapse subnav">
                                            <li class="@if (request()->path() == 'admin/mail-from-admin') active @endif">
                                                <a
                                                    href="{{ route('admin.mailFromAdmin') . '?language=' . $default->code }}">
                                                    <span class="sub-item">{{ __('Mail from Admin') }}</span>
                                                </a>
                                            </li>
                                            <li class="@if (request()->path() == 'admin/mail-to-admin') active @endif">
                                                <a
                                                    href="{{ route('admin.mailToAdmin') . '?language=' . $default->code }}">
                                            ...
                                            @elseif (request()->routeIs('admin.edit_mail_template')) active @endif">
                                                <a
                                                    href="{{ route('admin.mail_templates') . '?language=' . $default->code }}">
                ...
                @if (empty($admin->role) || (!empty($permissions) && in_array('Language Management', $permissions)))
                    ...
                    <li
                        class="nav-item   @if (request()->path() == 'admin/languages') active
                        @elseif(request()->is('admin/language/*/edit*')) active
                        @elseif(request()->is('admin/language/*/admin-keyword')) active
                        ...
                        <div class="collapse  @if (request()->path() == 'admin/user-language/keywords') show
                            ...
                            <ul class="nav nav-collapse">
                                <li class="@if (request()->path() == 'admin/user-language/settings') active @endif">
                                    <a
                                        href="{{ route('admin.userlanguage.settings') . '?language=' . $default->code }}">
                                        <span class="sub-item">{{ __('Settings') }}</span>
                                    </a>
                                </li>
                                <li class="@if (request()->path() == 'admin/user-language/keywords') active @endif">
                                    <a
                                        href="{{ route('admin.userlanguage.keywords') . '?language=' . $default->code }}">

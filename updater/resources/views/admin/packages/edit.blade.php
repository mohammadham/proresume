            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-sm float-right d-inline-block"
                        href="{{ route('admin.package.index') . '?language=' . $default->code }}">
                            ...
                            <form id="ajaxEditForm" class="" action="{{ route('admin.package.update') }}"
                                    ...
                                    <div class="selectgroup selectgroup-pills">
                                        ...
                                        <label class="selectgroup-item">
                                            <input type="checkbox" name="features[]" value="Gallery"
                                                class="selectgroup-input"
                                                @if (is_array($permissions) && in_array('Gallery', $permissions)) checked @endif>
                                            <span class="selectgroup-button">{{ __('Gallery') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="checkbox" name="features[]" value="Work Process"
                                                class="selectgroup-input"
                                                @if (is_array($permissions) && in_array('Work Process', $permissions)) checked @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3 col-sm-2 mb-2">
                                            <label class="imagecheck mb-2">
                                                <input name="themes[]" type="checkbox" value="9"
                                                    class="imagecheck-input"
                                                    @if (is_array($themes) && in_array(9, $themes)) checked @endif>
                                                <figure class="imagecheck-figure">
                                        ...
                                        <div class="col-3 col-sm-2 mb-2">
                                            <label class="imagecheck mb-2">
                                                <input name="themes[]" type="checkbox" value="10"
                                                    class="imagecheck-input"
                                                    @if (is_array($themes) && in_array(10, $themes)) checked @endif>
                                                <figure class="imagecheck-figure">
                                        ...
                                        <div class="col-3 col-sm-2 mb-2">
                                            <label class="imagecheck mb-2">
                                                <input name="themes[]" type="checkbox" value="11"
                                                    class="imagecheck-input"
                                                    @if (is_array($themes) && in_array(11, $themes)) checked @endif>
                                                <figure class="imagecheck-figure">
                                        ...
                                        <div class="col-3 col-sm-2 mb-2">
                                            <label class="imagecheck mb-2">
                                                <input name="themes[]" type="checkbox" value="12"
                                                    class="imagecheck-input"
                                                    @if (is_array($themes) && in_array(12, $themes)) checked @endif>
                                                <figure class="imagecheck-figure">

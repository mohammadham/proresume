...
@section('content')
    <div class="page-header">
        ...
        <a href="{{ route('admin.register.user') . '?language=' . $default->code }}" class="btn-md btn btn-primary ml-auto">{{ __('Back') }}</a>
    </div>
    <div class="row">
        <div class="col-md-3">
            <div class="card">
                        ...
                        <div class="col-lg-1">
                            <form id="onlineStatus{{ $user->id }}" class="d-inline-block"
                              ...
                              <select
                                ...
                                <option value="0" {{ $user->online_status == 0 ? 'selected' : '' }}>{{ __('Yes') }}</option>
                                <option value="1" {{ $user->online_status == 1 ? 'selected' : '' }}>{{ __('No') }}</option>
                             </select>
                            </form>
                        </div>
                    </div>

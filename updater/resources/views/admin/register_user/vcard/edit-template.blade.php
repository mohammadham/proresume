<div class="modal fade" id="editTemplate{{ $vcard->id }}" tabindex="-1" role="dialog" aria-labelledby="urlsModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editTemplateFormSubmit{{ $vcard->id }}" method="post" enctype="multipart/form-data"
                    action="{{ route('admin.register.user.edit_vcard_ptemplate') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="preview_template_name" type="text"
                            value="{{ $vcard->preview_template_name }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="preview_template_serial_number" type="text"
                            value="{{ $vcard->preview_template_serial_number }}">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary"
                    onclick="document.getElementById('editTemplateFormSubmit{{ $vcard->id }}').submit();">
                    {{ __('Submit') }}
                </button>
            </div>
        </div>

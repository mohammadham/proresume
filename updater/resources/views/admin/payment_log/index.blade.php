                                        ...
                                        <tbody>
                                            @foreach ($memberships as $key => $membership)
                                                <tr>
                                                    ...
                                                    <td><a target="_blank"
                                                            href="{{ route('admin.package.edit', $membership->package_id) }}">{{ __($membership->package->title) }}
                                                            [{{ __($membership->package->term) }}]</a></td>
                                                    @php
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="d-inline-block mx-auto">
                           {{ $memberships->appends(['language' => $default->code])->links() }}
                        </div>
                    </div>
                </div>
            </div>

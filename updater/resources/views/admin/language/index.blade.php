...
@section('content')
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="#" class="btn btn-success float-right mr-1 editBtn" data-toggle="modal"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-secondary btn-sm"
                                                            href="{{ route('admin.language.editKeyword', $language->id) . '?language=' . $default->code }}">
                                                            <span class="btn-label">
                                                        ...
                                                        <a class="btn btn-secondary btn-sm"
                                                            href="{{ route('admin.language.editAdminKeyword', $language->id) . '?language=' . $default->code }}">
                                                            <span class="btn-label">
                                                                <i class="fas fa-edit"></i>
                                                            </span>
                                                        ...
                                                        <a class="btn btn-success btn-sm"
                                                            href="{{ route('admin.language.editUserKeyword', $language->id) . '?language=' . $default->code }}">
                                                            <span class="btn-label">
                                                                <i class="fas fa-edit"></i>
                                                            </span>
                                                            {{ __('Edit User Dashboard Keyword') }}
                                                        </a>
                                                        <a class="btn btn-success btn-sm"
                                                            href="{{ route('admin.language.editCustomerKeyword', $language->id) . '?language=' . $default->code }}">
                                                            <span class="btn-label">
                                                                <i class="fas fa-edit"></i>
                                                            </span>
                                                            {{ __('Edit User Frontend Keyword') }}
                                                        </a>

                                                        <a class="btn btn-secondary btn-sm"
                                                            href="{{ route('admin.language.edit', $language->id) . '?language=' . $default->code }}">
                                                            <span class="btn-label">
                                                                <i class="fas fa-edit"></i>
                                                            </span>
                                                            {{ __('Edit') }}
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
        <form id="adminAddKeyword" action="{{ route('admin.language_management.add_keyword') }}" method="POST">
            @csrf
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button data-form="adminAddKeyword" type="submit" class="submitBtn btn btn-primary btn-sm">
                            {{ __('Submit') }}
                        </button>
                    </div>
                </div>

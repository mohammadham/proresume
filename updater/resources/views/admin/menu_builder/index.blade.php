                                ...
                                <div class="card-body">
                                    <ul class="list-group menu-builder-list">
                                        ...
                                        <li class="list-group-item">{{ __('Website Templates') }} <a
                                                data-text="{{ __('Website Templates') }}" data-type="website_templates"
                                                class="addToMenus btn btn-primary btn-sm float-right"
                                                href="">{{ __('Add to Menus') }}</a></li>
                                        <li class="list-group-item">{{ __('Cv Templates') }} <a
                                                data-text="{{ __('Cv Templates') }}" data-type="cv_templates"
                                                class="addToMenus btn btn-primary btn-sm float-right"
                                                href="">{{ __('Add to Menus') }}</a></li>
                                        <li class="list-group-item">{{ __('Vcards') }} <a data-text="{{ __('Vcards') }}"
                                                data-type="vcards" class="addToMenus btn btn-primary btn-sm float-right"
                                                href="">{{ __('Add to Menus') }}</a></li>

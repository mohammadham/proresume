        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card-title d-inline-block">{{ __('Payment Logs') }}
                            </div>
                        </div>
                        <div class="col-lg-3">
                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if (!empty($membership->package))
                                                            ...
                                                            <span
                                                                class="badge badge-secondary badge-xs">{{ __($membership->package->term) }}</span>
                                                        @endif
                                                    </td>
                                                    @php
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <p><strong>{{ __('Term') }}:
                                                                    </strong> {{ __($membership->package->term) }}
                                                                </p>
                                                                ...
                                                                <p><strong>{{ __('Expire Date') }}:
                                                                    ...
                                                                    @else
                                                                        @if ($membership->modified == 1)
                                                                            ...
                                                                            <span class="badge badge-primary btn-xs">

...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ __('Appointment Settings') }}</h4>
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a
                    href="{{ route('user.forminput') . '?language=' . request('language') }}">{{ __('Form Builder') }}</a>
            </li>
        </ul>
    </div>
    ...
    <div class="row" id="app">
        <div class="col-lg-7">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-warning">** {{ __('Do not create') }} <strong
                            class="text-danger">{{ __('Name') }} &amp;
                            {{ __('Email') }}</strong>
                        {{ __('input field, it will be in the Appointment form By default') }}
                        .</p>
                    @if (count($inputs) > 0)
                        <div id="sortable">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        ...
                        @if (!empty($back_url))
                            <a href="{{ $back_url }}"
                                class="btn btn-primary btn-sm float-right text-white">{{  __('Back') }}</a>
                        @endif
                    </div>
                </div>
                <form id="ajaxForm" action="{{ route('user.form.store') }}" method="post"
                    ...
                    <div class="form-group" v-show="fileExtensions">
                        <label
                            for=""><strong>{{ __('File Extensions') }}</strong></label>
                    ...
                    <div class="form-group text-center">
                        <button id="" data-form="ajaxForm" type="submit"
                            class="submitBtn btn btn-primary btn-sm">{{ __('ADD FIELD') }}</button>
                    </div>
                </form>
            </div>

            ...
            <div class="modal-body">
                <form id="editForm" action="{{ route('user.category.store') }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" name="name" id="name" placeholder="{{ __('Enter category name') }}"
                            class="form-control ">
                    </div>
                    <div class="form-group">
                        <label for="">{{ __('Fee') }} * ({{ $userBs->base_currency_symbol }})</label>
                        <input required type="number" name="price" id="price"
                            placeholder="{{ __('Enter fee') }}" class="form-control ">
                    </div>
                </form>
            </div>

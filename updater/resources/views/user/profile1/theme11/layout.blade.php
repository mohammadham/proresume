...
<head>
    ...
    <!-- base CSS -->
    <link rel="stylesheet" href="{{ asset('assets/front/theme11') }}/css/base.css">
    <link rel="stylesheet" href="{{ asset('assets/front/theme11') }}/css/header/header.css">
    <link rel="stylesheet" href="{{ asset('assets/front/theme11') }}/css/homepage/home-page.css">
    <link rel="stylesheet" href="{{ asset('assets/front/theme11') }}/css/footer/footer.css">
    @if ($userCurrentLang->rtl == 1)
        <link rel="stylesheet" href="{{ asset('assets/front/theme11') }}/css/rtl-style.css">
    @endif
    @yield('styles')
    @php
...
<body>
    ...
    <div class="pages">
        ...
        @include('user.profile1.theme11.header')
            ...
            <div class="container">
                @if (is_array($userPermissions) && in_array('Footer Mail', $userPermissions))
                    <div class="footer-top text-center mb-20">
                        ...
                        <a class="fw-medium" href="mailto:{{ $user->email }}">{{ $user->email }}</a>
                    </div>
                @endif
    ...
    <!-- header-menu JS -->
    <script src="{{ asset('assets/front/theme9-12') }}/js/vendor/svg-injector.min.js"></script>
    <script src="{{ asset('assets/front/theme11') }}/js/vendor/header-menu.js"></script>
    <!-- back-to-top -->
    <script src="{{ asset('assets/front/theme11') }}/js/vendor/back-to-top.js"></script>
    <!-- custom -->
    <script src="{{ asset('assets/front/theme11') }}/js/script.js"></script>
    <script>
        "use strict";

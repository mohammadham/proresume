...
<head>
    ...
    <!-- Style CSS -->
    <link rel="stylesheet" href="{{ asset('assets/front/theme10') }}/css/common.css">
    @if ($userCurrentLang->rtl == 1)
        <link rel="stylesheet" href="{{ asset('assets/front/theme10') }}/css/rtl-style.css">
    @endif
    @yield('styles')
    @php
...
<body>
    ...
    <!-- header -->
    @include('user.profile1.theme10.header')
    @include('user.profile1.theme10.mobile-header')
    ...
    <!-- header-menu JS -->
    <script src="{{ asset('assets/front/theme10') }}/js/header-menu.js"></script>
    <!-- back-to-top -->
    <script src="{{ asset('assets/front/theme10') }}/js/back-to-top.js"></script>
    <!-- custom -->
    <script src="{{ asset('assets/front/theme10') }}/js/script.js"></script>
    <script>
        "use strict";

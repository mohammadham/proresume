        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title d-inline-block">{{ __('Edit Testimonial') }}
                    </div>
                            ...
                            <form id="ajaxForm" class="" action="{{ route('user.testimonial.update') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="occupation"
                                        value="{{ $testimonial->occupation }}" placeholder="{{ __('Enter occupation') }}">
                                    <p id="erroccupation" class="mb-0 text-danger em"></p>
                                </div>
                                <div class="form-group">
                                    <label for="">{{ __('Feedback') }} **</label>
                                    <textarea class="form-control" name="content" rows="5" placeholder="{{ __('Enter Feedback') }}">{{ replaceBaseUrl($testimonial->content) }}</textarea>
                                ...
                                @if ($userBs->theme == 12)
                                    <div class="form-group">
                                        ...
                                        <input type="url" class="form-control" name="rate"
                                            placeholder="{{ __('Enter rating') }}" value="{{ $testimonial->rate }}">
                                        <p id="errrate" class="mb-0 text-danger em"></p>
                                    </div>
                                @endif
                                <div class="form-group">

            ...
            <div class="modal-body">
                ...
                <form id="ajaxEditForm" enctype="multipart/form-data" class="modal-form"
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <div class="col-12 mb-2">
                                    <label
                                        for="image"><strong>{{ __('Image') }}*</strong></label>
                                </div>
                    ...
                    <div id="editApp">
                        <div class="form-group">
                            <label
                                class="form-label">{{ __('External Link Status') }}
                                **</label>
                        ...
                        <div class="form-group" id="eextLink" style="display: none;">
                            ...
                            <p class="text-warning mb-0">
                                {{ __('If you dont want any details content, then leave this field blank') }}
                            </p>
                        ...
                        <div class="form-group" id="eshortDetails" style="display: none;">
                            ...
                            <textarea id="inshort_details" class="form-control {{ $vcard->direction == 2 ? 'rtl' : '' }}" name="short_details"
                                rows="4" cols="80" placeholder="{{ __('Enter short details') }}"></textarea>
                            <p class="text-warning mb-0">
                                {{ __('If you dont want any details content, then leave this field blank') }}
                            </p>
                    ...
                    <div class="form-group">
                        ...
                        <p class="text-warning mb-0">
                            <small>{{ __('The higher the serial number is, the later the project will be shown') }}.</small>
                        </p>
                    </div>
                </form>
            </div>

                                ...
                                <div class="row">
                                    ...
                                    @if ($vcard->template == 6)
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label
                                                    for="">{{ __('Summary Section Background Color') }}
                                                    **</label>
                                    ...
                                    @if ($vcard->template != 5 && $vcard->template != 6 && $vcard->template != 9 && $vcard->template != 10)
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label
                                                    for="">{{ __("'Add to Contact' Button Color") }}
                                                    **</label>
                                                <input type="text" class="form-control jscolor"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label
                                                    for="">{{ __("'Share vCard' Button Color") }}
                                                    **</label>
                                                <input type="text" class="form-control jscolor"

                            ...
                            <form id="ajaxForm" class="" action="{{ route('user.vcard.store') }}" method="POST"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <div class="col-12 mb-2">
                                                <label
                                                    for="image"><strong>{{ __('Profile Image') }}</strong></label>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <p class="text-warning mb-0">
                                                {{ __('Enter Phone Number with') }}
                                                <strong
                                                    class="text-danger">{{ __('Country Code') }}</strong>
                                            </p>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label
                                                for="summary">{{ __('Introduction') }}</label>
                                            <textarea name="introduction" id="introduction" class="form-control" rows="4"
                                                placeholder="{{ __('Enter Introduction') }}"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="app">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for=""
                                                    class="d-block mb-2">{{ __('Other Infromation') }}</label>
                                                <button class="btn btn-primary"
                                                    @click="addInformation">{{ __('Add Information') }}</button>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="form-group from-show-notify row">
                            <div class="col-12 text-center">
                                <button data-form="ajaxForm" type="submit" id=""
                                    class="submitBtn btn btn-success">{{ __('Submit') }}</button>
                            </div>
                        </div>
                    </div>
                </div>

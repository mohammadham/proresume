                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="card-title">
                                    {{  __('Update SEO Informations') }}</div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="experience_meta_description" rows="5"
                                            placeholder="{{  __('Enter Meta Description') }}">{{ $data->experience_meta_description }}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="testimonial_meta_description" rows="5"
                                            placeholder="{{ __('Enter Meta Description') }}">{{ $data->testimonial_meta_description }}</textarea>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="portfolios_meta_description" rows="5"
                                        placeholder="{{ __('Enter Meta Description') }}">{{ $data->portfolios_meta_description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>

        ...
        <div class="container">
            ...
            <div class="filter-grid row">
                @foreach ($portfolios as $portfolio)
                    <div class="col-lg-4 col-md-6 col-sm-12 grid-column cat-{{ $portfolio->bcategory->id }}">
                        <div class="work-item mb-30">
                            <div class="work-img">
                                <a
                                    href="{{ route('front.user.portfolio.detail', [getParam(), $portfolio->slug, $portfolio->id]) }}"><img

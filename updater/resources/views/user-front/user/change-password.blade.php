...
@section('content')
@if ($userBs->theme == 6 || $userBs->theme == 7 || $userBs->theme == 8 || $userBs->theme == 9 || $userBs->theme == 10 || $userBs->theme == 11 || $userBs->theme == 12)
<!--====== Breadcrumbs Start ======-->
            ...
            <div class="col-lg-10">
                <div class="page-title">
                    ...
                    <ul class="breadcrumbs-link">
                        ...
                        <li class="">{{ $keywords['Change_Password'] ?? __('Change Password') }}</li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="single-form mt-2 mb-4">
                                        <button class="@if ($userBs->theme == 1 || $userBs->theme == 2 ) template-btn @else main-btn @endif">{{ $keywords['save_change'] ?? __('Save Change') }}</button>
                                    </div>
                                </div>
                            </div>
                        </form>

                    ...
                    @foreach ($featured_users as $featured_user)
                        <div class="user-item">
                            ...
                            <div class="user-button">
                                ...
                                @endphp
                                <ul>
                                    <li><a href="{{ detailsUrl($featured_user) }}" class="main-btn" target="_blank"><i
                                                ...
                                                <ul class="list">
                                                    ...
                                                    @foreach ($allPfeatures as $feature)
                                                        ...
                                                        @elseif ($feature == 'Blog')
                                                            ...
                                                            <li
                                                                class="{{ $package->number_of_blog_categories ? 'checked' : 'unchecked' }}">
                                                        ...
                                                        @elseif ($feature == 'Portfolio')
                                                            ...
                                                            <li
                                                                class="{{ $package->number_of_portfolio_categories ? 'checked' : 'unchecked' }}">

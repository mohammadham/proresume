...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'featureLimitsCheck' => \App\Http\Middleware\CheckPackageLimits::class,
        'adminMenuCheck' => \App\Http\Middleware\MenuPermissionsCheck::class,
        'userLang' => \App\Http\Middleware\UserLangLocale::class,
        'userWebsiteLang' => \App\Http\Middleware\UserWebsiteLocale::class,
    ];

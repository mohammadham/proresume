...
Route::domain($domain)->group(function () {
    ...
    Route::group(['middleware' => 'setlang'], function () {
        Route::group(['middleware' => 'adminMenuCheck'], function () {
            Route::get('/', 'Front\FrontendController@index')->name('front.index');
            Route::get('/website-templates', 'Front\FrontendController@templates')->name('front.templates');
            Route::get('/cv-templates', 'Front\FrontendController@cvtemplates')->name('front.cv.templates');
    ...
    Route::group(['prefix' => 'user', 'middleware' => ['auth', 'userstatus', 'userLang']], function () {
        ...
        Route::group(['middleware' => 'checkUserPermission:Follow/Unfollow'], function () {
            ...
            Route::get('/follow/{id}', 'User\FollowerController@follow')->name('user.follow')->middleware('setlang');
        ...
        Route::group(['middleware' => 'checkUserPermission:vCard'], function () {
            ...
            Route::post('/vcard/store', 'User\VcardController@store')->name('user.vcard.store')->middleware('featureLimitsCheck:vcards,store');
            Route::get('/vcard/{uservcard}/edit', 'User\VcardController@edit')->name('user.vcard.edit');
            Route::post('/vcard/update', 'User\VcardController@update')->name('user.vcard.update')->middleware('featureLimitsCheck:vcards,update');
            ...
            Route::post('/vcard/service/store', 'User\VcardController@serviceStore')->name('user.vcard.serviceStore')->middleware('featureLimitsCheck:vcards,store');
            Route::post('/vcard/service/update', 'User\VcardController@serviceUpdate')->name('user.vcard.serviceUpdate')->middleware('featureLimitsCheck:vcards,update');
            ...
            Route::post('/vcard/project/store', 'User\VcardController@projectStore')->name('user.vcard.projectStore')->middleware('featureLimitsCheck:vcards,store');
            Route::post('/vcard/project/update', 'User\VcardController@projectUpdate')->name('user.vcard.projectUpdate')->middleware('featureLimitsCheck:vcards,update');
            ...
            Route::post('/vcard/testimonial/store', 'User\VcardController@testimonialStore')->name('user.vcard.testimonialStore')->middleware('featureLimitsCheck:vcards,store');
            Route::post('/vcard/testimonial/update', 'User\VcardController@testimonialUpdate')->name('user.vcard.testimonialUpdate')->middleware('featureLimitsCheck:vcards,update');
            ...
            Route::post('/vcard/aboutUpdate', 'User\VcardController@aboutUpdate')->name('user.vcard.aboutUpdate')->middleware('featureLimitsCheck:vcards,update');

            Route::get('/vcard/{id}/preferences', 'User\VcardController@preferences')->name('user.vcard.preferences');
            Route::post('/vcard/{id}/prefUpdate', 'User\VcardController@prefUpdate')->name('user.vcard.prefUpdate')->middleware('featureLimitsCheck:vcards,update');

            Route::get('/vcard/{id}/color', 'User\VcardController@color')->name('user.vcard.color');
            Route::post('/vcard/{id}/colorUpdate', 'User\VcardController@colorUpdate')->name('user.vcard.colorUpdate')->middleware('featureLimitsCheck:vcards,update');

            Route::get('/vcard/{id}/keywords', 'User\VcardController@keywords')->name('user.vcard.keywords');
            Route::post('/vcard/{id}/keywordsUpdate', 'User\VcardController@keywordsUpdate')->name('user.vcard.keywordsUpdate')->middleware('featureLimitsCheck:vcards,update');
        });
        ...
        Route::group(['prefix' => 'appointment'], function () {
            ...
            Route::get('/fetch-timeslot', 'User\AppointmentController@fetchTimeslots')->name('user.appointment.fetchTimeslots');
            Route::get('/check-timeslot', 'User\AppointmentController@checkTheTimeslot')->name('user.appointment.check_timeslot');
            ...
            Route::post('/category/featured', 'User\CategoryController@categoryFeatured')->name('user.category.featured');
        ...
        Route::post('/language/{id}/update/keyword', 'User\LanguageController@updateKeyword')->name('user.language.updateKeyword')->middleware('featureLimitsCheck:languages,update');
        Route::post('/language/store', 'User\LanguageController@store')->name('user.language.store')->middleware('featureLimitsCheck:languages,store');
        Route::post('/language/upload', 'User\LanguageController@upload')->name('user.language.upload')->middleware('featureLimitsCheck:languages,store');
        Route::post('/language/{id}/uploadUpdate', 'User\LanguageController@uploadUpdate')->name('user.language.uploadUpdate')->middleware('featureLimitsCheck:languages,update');
        Route::post('/language/{id}/default', 'User\LanguageController@default')
            ->name('user.language.default')
            ->middleware('featureLimitsCheck:languages,update');
        Route::post('/language/{id}/delete', 'User\LanguageController@delete')->name('user.language.delete');
        Route::post('/add-keyword', 'User\LanguageController@addKeyword')->name('user.language_management.add_keyword')->middleware('featureLimitsCheck:languages,store');
        Route::post('/language/update', 'User\LanguageController@update')->name('user.language.update')->middleware('featureLimitsCheck:languages,update');
        ...
        //user work process
        Route::get('/work-process', 'User\WorkProcessController@index')->name('user.work.process.index');
        Route::post('/work-process/store', 'User\WorkProcessController@store')->name('user.work.process.store');
        Route::post('/work-process/update', 'User\WorkProcessController@update')->name('user.work.process.update');
        Route::post('/work-process/delete', 'User\WorkProcessController@delete')->name('user.work.process.delete');
        Route::post('/work-process/bulkdelete', 'User\WorkProcessController@bulkdelete')->name('user.work.process.bulkdelete');

        //user gallery
        Route::get('/gallery', 'User\GalleryController@index')->name('user.gallery.index');
        Route::post('/gallery/store', 'User\GalleryController@store')->name('user.gallery.store');
        Route::post('/gallery/update', 'User\GalleryController@update')->name('user.gallery.update');
        Route::post('/gallery/delete', 'User\GalleryController@delete')->name('user.gallery.delete');
        Route::post('/gallery/bulkdelete', 'User\GalleryController@bulkdelete')->name('user.gallery.bulkdelete');

        //user features
        Route::get('/features', 'User\FeaturesController@index')->name('user.features.index');
        Route::post('/features/store', 'User\FeaturesController@store')->name('user.features.store');
        Route::post('/features/update', 'User\FeaturesController@update')->name('user.features.update');
        Route::post('/features/delete', 'User\FeaturesController@delete')->name('user.features.delete');
        Route::post('/features/bulkdelete', 'User\FeaturesController@bulkdelete')->name('user.features.bulkdelete');
        ...
        Route::group(['middleware' => ['checkUserPermission:Blog']], function () {
            ...
            Route::post('/blog-category/store', 'User\BlogCategoryController@store')->name('user.blog.category.store')->middleware('featureLimitsCheck:blogCategories,store');
            Route::post('/blog-category/update', 'User\BlogCategoryController@update')->name('user.blog.category.update')->middleware('featureLimitsCheck:blogCategories,update');
            ...
            //user blogs
            Route::get('blog/posts', 'User\BlogController@index')->name('user.blog.index');
            Route::post('/blog/upload', 'User\BlogController@upload')->name('user.blog.upload')->middleware('featureLimitsCheck:blogs,store');
            Route::post('/blog/store', 'User\BlogController@store')->name('user.blog.store')->middleware('featureLimitsCheck:blogs,store');
            Route::get('/blog/posts/{blog}/edit', 'User\BlogController@edit')->name('user.blog.edit');
            Route::post('/blog/update', 'User\BlogController@update')->name('user.blog.update')->middleware('featureLimitsCheck:blogs,update');
            Route::post('/blog/{id}/uploadUpdate', 'User\BlogController@uploadUpdate')->name('user.blog.uploadUpdate')->middleware('featureLimitsCheck:blogs,update');
        ...
        Route::group(['middleware' => 'checkUserPermission:Skill'], function () {
            ...
            Route::post('/skill/upload', 'User\SkillController@upload')->name('user.skill.upload')->middleware('featureLimitsCheck:skills,store');
            Route::post('/skill/store', 'User\SkillController@store')->name('user.skill.store')->middleware('featureLimitsCheck:skills,store');
            Route::get('/skill/{skill}/edit', 'User\SkillController@edit')->name('user.skill.edit');
            Route::post('/skill/update', 'User\SkillController@update')->name('user.skill.update')->middleware('featureLimitsCheck:skills,update');
            Route::post('/skill/{id}/uploadUpdate', 'User\SkillController@uploadUpdate')->name('user.skill.uploadUpdate')->middleware('featureLimitsCheck:skills,update');
        ...
        Route::group(['middleware' => 'checkUserPermission:Portfolio'], function () {
            ...
            Route::post('/portfolio-category/store', 'User\PortfolioCategoryController@store')->name('user.portfolio.category.store')->middleware('featureLimitsCheck:portfolioCategories,store');
            Route::post('/portfolio-category/update', 'User\PortfolioCategoryController@update')->name('user.portfolio.category.update')->middleware('featureLimitsCheck:portfolioCategories,update');
            ...
            Route::post('/portfolio/store', 'User\PortfolioController@store')->name('user.portfolio.store')->middleware('featureLimitsCheck:portfolios,store');
            Route::post('/portfolio/sliderstore', 'User\PortfolioController@sliderstore')->name('user.portfolio.sliderstore')->middleware('featureLimitsCheck:portfolios,store');
            Route::post('/portfolio/sliderupdate', 'User\PortfolioController@sliderupdate')->name('user.portfolio.sliderupdate')->middleware('featureLimitsCheck:portfolios,update');
            Route::post('/portfolio/sliderrmv', 'User\PortfolioController@sliderrmv')->name('user.portfolio.sliderrmv')->middleware('featureLimitsCheck:portfolios,update');
            ...
            Route::post('/portfolio/sliderupdate', 'User\PortfolioController@sliderupdate')->name('user.portfolio.sliderupdate')->middleware('featureLimitsCheck:portfolios,update');
            Route::post('/portfolio/update', 'User\PortfolioController@update')->name('user.portfolio.update')->middleware('featureLimitsCheck:portfolios,update');
        ...
        Route::group(['middleware' => 'checkUserPermission:Service'], function () {
            ...
            Route::post('/service/store', 'User\ServiceController@store')->name('user.service.store')->middleware('featureLimitsCheck:services,store');
            Route::get('/service/{service}/edit', 'User\ServiceController@edit')->name('user.service.edit');
            Route::post('/service/update', 'User\ServiceController@update')->name('user.service.update')->middleware('featureLimitsCheck:services,update');
        ...
        Route::group(['middleware' => 'checkUserPermission:Experience'], function () {
            ...
            Route::post('/job-experience/store', 'User\JobExperienceController@store')->name('user.job.experience.store')->middleware('featureLimitsCheck:jobExpriences,store');
            Route::get('/job-experience/{experience}/edit', 'User\JobExperienceController@edit')->name('user.job.experience.edit');
            Route::post('/job-experience/update', 'User\JobExperienceController@update')->name('user.job.experience.update')->middleware('featureLimitsCheck:jobExpriences,update');
            ...
            Route::post('/experience/upload', 'User\EducationController@upload')->name('user.experience.upload')->middleware('featureLimitsCheck:educations,store');
            Route::post('/experience/store', 'User\EducationController@store')->name('user.experience.store')->middleware('featureLimitsCheck:educations,store');
            Route::get('/experience/{education}/edit', 'User\EducationController@edit')->name('user.experience.edit');
            Route::post('/experience/update', 'User\EducationController@update')->name('user.experience.update')->middleware('featureLimitsCheck:educations,update');
            Route::post('/experience/{id}/uploadUpdate', 'User\EducationController@uploadUpdate')->name('user.experience.uploadUpdate')->middleware('featureLimitsCheck:educations,update');
        ...
        Route::post('/iyzico/update', 'User\GatewayController@updateIyzicoInfo')->name('user.iyzico.update');
        Route::post('/midtrans/update', 'User\GatewayController@updateMidtransInfo')->name('user.midtrans.update');
        Route::post('/perfect_money/update', 'User\GatewayController@updatePerfectMoneyInfo')->name('user.perfect_money.update');
        Route::post('/myfatoorah/update', 'User\GatewayController@updateMyFatoorahInfo')->name('user.myfatoorah.update');
        Route::post('/toyyibpay/update', 'User\GatewayController@updateToyyibpayInfo')->name('user.toyyibpay.update');
        Route::post('/phonepe/update', 'User\GatewayController@updatePhonepeInfo')->name('user.phonepe.update');
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus', 'adminLang']], function () {
        ...
        Route::group(['middleware' => ['checkpermission:Registered Users', 'adminLang']], function () {
            ...
            Route::get('register/users/settings', 'Admin\RegisterUserController@settings')->name('admin.register.user.settings');
            Route::post('register/users/{id}/settings/update', 'Admin\RegisterUserController@settingsUpdate')->name('admin.register.user.settings.update');
            ...
            Route::get('user/vcards', 'Admin\VcardController@index')->name('admin.register.user.vcard');
            Route::post('user/vcards-delete', 'Admin\VcardController@delete')
                ->name('admin.register.user.vcard_delete');
            Route::post('user/vcards-bulkdelete', 'Admin\VcardController@bulkDelete')
                ->name('admin.register.user.vcard_bulk_delete');
            Route::post('user/vcards-status-update', 'Admin\VcardController@statusUpdate')
                ->name('admin.register.user.vcard_status_update');
            Route::post('user/add-vcard-ptemplate', 'Admin\VcardController@addPtemplate')
                ->name('admin.register.user.add_vcard_ptemplate');
            Route::post('user/edit-vcard-ptemplate', 'Admin\VcardController@editPtemplate')
                ->name('admin.register.user.edit_vcard_ptemplate');
            Route::post('user/delete-prevtemplate', 'Admin\VcardController@deletePrevTemplate')
                ->name('admin.register.user.delete_prevtemplate');


            Route::get('user/cv', 'Admin\CvController@cv')->name('admin.register.user.cv');
            Route::post('user/cv-status-update', 'Admin\CvController@statusUpdate')->name('admin.register.user.cv_status_update');
            Route::post('user/cv-add-template', 'Admin\CvController@addPtemplate')->name('admin.register.user.cv_template_add');
            Route::post('user/cv-edit-template', 'Admin\CvController@editPtemplate')->name('admin.register.user.cv_template_update');
            Route::post('user/cv-delete-template', 'Admin\CvController@deletePrevTemplate')->name('admin.register.user.cv_template_delete');
        });
        ...
        Route::group(['middleware' => 'checkpermission:Payment Gateways'], function () {
            ...
            // for shohag-4.0
            Route::post('/midtrans', 'Admin\GatewayController@updateMidtransInfo')->name('admin.update_midtrans_info');
            Route::post('/iyzico', 'Admin\GatewayController@updateIyzicoInfo')->name('admin.update_iyzico_info');
            Route::post('/paytabs', 'Admin\GatewayController@updatePaytabsInfo')->name('admin.update_paytabs_info');
            Route::post('/toyyibpay', 'Admin\GatewayController@updateToyyibpayInfo')->name('admin.update_toyyibpay_info');
            Route::post('/phonepe', 'Admin\GatewayController@updatePhonepeInfo')->name('admin.update_phonepe_info');
            Route::post('/yoco', 'Admin\GatewayController@updateYocoInfo')->name('admin.update_yoco_info');
        ...
        Route::group(['middleware' => 'checkpermission:Language Management'], function () {
            ...
            Route::get('/language/{id}/edit/user-keyword', 'Admin\LanguageController@editUserKeyword')->name('admin.language.editUserKeyword');
            Route::post('/language/{id}/update/user/keyword', 'Admin\LanguageController@updateUserDashboardKeyword')->name('admin.language.updateUserDashboardKeyword');
            Route::get('/language/{id}/edit/customer-keyword', 'Admin\LanguageController@editCustomerKeyword')->name('admin.language.editCustomerKeyword');
            Route::post('/language/{id}/update/customer/keyword', 'Admin\LanguageController@updateCustomerKeyword')->name('admin.language.updateCustomerKeyword');
    ...
    @default
        ',
            ...
            Route::post('/add-user-dashboard-keyword', 'Admin\LanguageController@addTenantDashboardKeyword')->name('admin.language_management.user.add_keyword');
            Route::post('/add-frontend-keyword', 'Admin\LanguageController@addAdminFrontKeyword')->name('admin.language_management.add_front_keyword');
...
Route::group(['domain' => $domain, 'prefix' => $prefix], function () {
    ...
    */
    ...
    Route::prefix('appointment')->group(function () {
        ...
        Route::get('/midtrans/notify', 'User\Payment\MidtransController@creditCardNotify')
            ->name('customer.appointment.midtrans.notify');
        Route::get('/midtrans/cancel', 'User\Payment\MidtransController@cancelPayment')
            ->name('customer.appointment.midtrans.cancel');

        Route::post('/iyzico/notify', 'User\Payment\IyzicoController@successPayment')
            ->name('customer.appointment.lyzico.notify');
        Route::get('/iyzico/cancel', 'User\Payment\IyzicoController@cancelPayment')
            ->name('customer.appointment.lyzico.cancel');

        Route::post('/paytabs/notify', 'User\Payment\PaytabsController@successPayment')
            ->name('customer.appointment.paytabs.notify');
        Route::get('/paytabs/cancel', 'User\Payment\PaytabsController@cancelPayment')
            ->name('customer.appointment.paytabs.cancel');

        Route::get('/toyyibpay/notify', 'User\Payment\ToyyibpayController@successPayment')
            ->name('customer.appointment.toyyibpay.notify');
        Route::get('/toyyibpay/cancel', 'User\Payment\ToyyibpayController@cancelPayment')
            ->name('customer.appointment.toyyibpay.cancel');

        Route::get('/phonepe/notify', 'User\Payment\PhonePeController@successPayment')
            ->name('customer.appointment.phonepe.notify');
        Route::get('/phonepe/cancel', 'User\Payment\PhonePeController@cancelPayment')
            ->name('customer.appointment.phonepe.cancel');

        Route::get('/yoco/notify', 'User\Payment\YocoController@successPayment')
            ->name('customer.appointment.yoco.notify');
        Route::get('/yoco/cancel', 'User\Payment\YocoController@cancelPayment')
            ->name('customer.appointment.yoco.cancel');

        Route::get('/myfatoorah/notify', 'User\Payment\MyFatoorahController@successPayment')
            ->name('customer.appointment.myfatoorah.notify');
        Route::get('/myfatoorah/cancel', 'User\Payment\MyFatoorahController@cancelPayment')
            ->name('customer.appointment.myfatoorah.cancel');

        Route::get('/xendit/notify', 'User\Payment\XenditController@successPayment')
            ->name('customer.appointment.xendit.notify');
        Route::get('/xendit/cancel', 'User\Payment\XenditController@cancelPayment')
            ->name('customer.appointment.xendit.cancel');

        Route::get('/perfect_money/notify', 'User\Payment\PerfectMoneyController@successPayment')
    ...
    Route::prefix('/user')
        ->middleware(['auth:customer', 'activeCustomer', 'userWebsiteLang'])
        ->group(function () {
    ...
    Route::prefix('/user')
        ->middleware(['guest:customer', 'userWebsiteLang'])
        ->group(function () {
    ...
    Route::group(['middleware' => ['routeAccess:Appointment', 'userWebsiteLang']], function () {
    ...
    Route::group(['middleware' => ['routeAccess:Gallery']], function () {
        Route::get('/gallery', 'Front\FrontendController@userGallery')->name('front.user.gallery');
    });

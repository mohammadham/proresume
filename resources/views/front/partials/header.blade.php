        ...
        <div class="nav-container d-flex align-items-center justify-content-between">
            ...
            <div class="nav-menu">
                ...
                <div class="mobile-logo">
                    <a href="#"><img src="{{ asset('assets/front/img/' . $bs->logo) }}" class="img-fluid"
                            alt=""></a>
                </div>
                <!-- nav-menu -->
                <nav class="main-menu">
                ...
                <div class="nav-push-item d-none d-xl-block">
                    @guest
                        <div class="navbar-btn">
                            <a href="{{ route('user.login') }}" class="main-btn"><i
                                    class="fal fa-sign-in-alt"></i>{{ __('Login') }}</a>
                        </div>
                    @endguest
                    @auth
                        <div class="navbar-btn">
                            <a href="{{ route('user-dashboard') }}" class="main-btn"><i
                                    class="far fa-user"></i>{{ __('Dashboard') }}</a>
                        </div>
                    @endauth
                </div>

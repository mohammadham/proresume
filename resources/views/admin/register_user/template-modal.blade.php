            ...
            <div class="modal-body">
                <form action="{{ route('register.user.template') }}" id="templateForm{{ $user->id }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        @error('preview_image')
                            <p class="mb-0 text-danger em">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control ltr" name="template_name"
                            value="{{ old('template_name') }}" placeholder="{{ __('Enter Template Name') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control ltr" name="serial_number"
                            value="{{ old('serial_number') }}" placeholder="{{ __('Enter Serial Number') }}">

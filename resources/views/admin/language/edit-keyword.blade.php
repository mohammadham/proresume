        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-sm float-right d-inline-block" href="{{ route('admin.language.index') . '?language=' . $default->code  }}">
                        ...
                        <div class="form-group">
                            ...
                            @if ($isAdmin == 1)
                                <input type="text" class="form-control" name="keyword"
                                    placeholder="{{ __('Enter Keyword') }}" style="direction: {{ @$default->rtl == 0 ? 'ltr' : 'rtl' }};">

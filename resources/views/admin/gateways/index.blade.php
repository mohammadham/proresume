...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card">
                <form action="{{ route('admin.zibal.update') }}" method="post">
                    @csrf
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-12">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="status" value="1"
                                                class="selectgroup-input"
                                                {{ $zibal && $zibal->status == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Active') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="status" value="0"
                                                class="selectgroup-input"
                                                {{ $zibal && $zibal->status == 0 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Deactive') }}</span>
                                        </label>
                                    </div>
                                    @if ($errors->has('status'))
                                ...
                                @php $zibalInfo = json_decode(@$zibal->information, true); @endphp

                                <div class="form-group">
                                    <label>{{ __('Zibal Merchant ID') }}</label>
                                    <input type="text" class="form-control" name="merchant_id"
                                    ...
                                    @endif
                                    <p class="text-warning mt-1 mb-0">
                                        {{ __('You can get your Merchant ID from Zibal dashboard') }}
                                    </p>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @endif
                                    <p class="text-warning mt-1 mb-0">
                                        {{ __('Enable sandbox mode for testing') }}
                                    </p>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @endif
                                    <p class="text-warning mt-1 mb-0">
                                        {{ __('Payment description shown to user') }}
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <form action="{{ route('admin.idpay.update') }}" method="post">
                @csrf
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-12">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="status" value="1"
                                            class="selectgroup-input"
                                            {{ $idpay && $idpay->status == 1 ? 'checked' : '' }}>
                                        <span class="selectgroup-button">{{ __('Active') }}</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="status" value="0"
                                            class="selectgroup-input"
                                            {{ $idpay && $idpay->status == 0 ? 'checked' : '' }}>
                                        <span class="selectgroup-button">{{ __('Deactive') }}</span>
                                    </label>
                                </div>
                                @if ($errors->has('status'))
                            ...
                            @php $idpayInfo = json_decode(@$idpay->information, true); @endphp

                            <div class="form-group">
                                <label>{{ __('IDPay API Key') }}</label>
                                <input type="text" class="form-control" name="api_key"
                                ...
                                @endif>
                                <p class="text-warning mt-1 mb-0">
                                    {{ __('You can get your API Key from IDPay dashboard') }}
                                </p>
                            </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <form action="{{ route('admin.nextpay.update') }}" method="post">
                @csrf
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-12">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="status" value="1"
                                            class="selectgroup-input"
                                            {{ $nextpay && $nextpay->status == 1 ? 'checked' : '' }}>
                                        <span class="selectgroup-button">{{ __('Active') }}</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="status" value="0"
                                            class="selectgroup-input"
                                            {{ $nextpay && $nextpay->status == 0 ? 'checked' : '' }}>
                                        <span class="selectgroup-button">{{ __('Deactive') }}</span>
                                    </label>
                                </div>
                                @if ($errors->has('status'))
                            ...
                            @php $nextpayInfo = json_decode(@$nextpay->information, true); @endphp

                            <div class="form-group">
                                <label>{{ __('NextPay API Key') }}</label>
                                <input type="text" class="form-control" name="api_key"
                                ...
                                @endif>
                                <p class="text-warning mt-1 mb-0">
                                    {{ __('You can get your API Key from NextPay dashboard') }}
                                </p>
                            </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <form action="{{ route('admin.payir.update') }}" method="post">
                @csrf
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-12">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="status" value="1"
                                            class="selectgroup-input"
                                            {{ $payir && $payir->status == 1 ? 'checked' : '' }}>
                                        <span class="selectgroup-button">{{ __('Active') }}</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="status" value="0"
                                            class="selectgroup-input"
                                            {{ $payir && $payir->status == 0 ? 'checked' : '' }}>
                                        <span class="selectgroup-button">{{ __('Deactive') }}</span>
                                    </label>
                                </div>
                                @if ($errors->has('status'))
                            ...
                            @php $payirInfo = json_decode(@$payir->information, true); @endphp

                            <div class="form-group">
                                <label>{{ __('Pay.ir API Key') }}</label>
                                <input type="text" class="form-control" name="api_key"
                                ...
                                @endif>
                                <p class="text-warning mt-1 mb-0">
                                    {{ __('You can get your API Key from Pay.ir dashboard') }}
                                </p>
                            </div>
    ...
    {{-- Bank Mellat Information --}}
    <div class="col-lg-4">
        <div class="card">
            <form action="{{ route('admin.mellat.update') }}" method="post">
                @csrf
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-12">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="status" value="1"
                                            class="selectgroup-input"
                                            {{ $mellat && $mellat->status == 1 ? 'checked' : '' }}>
                                        <span class="selectgroup-button">{{ __('Active') }}</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="status" value="0"
                                            class="selectgroup-input"
                                            {{ $mellat && $mellat->status == 0 ? 'checked' : '' }}>
                                        <span class="selectgroup-button">{{ __('Deactive') }}</span>
                                    </label>
                                </div>
                                @if ($errors->has('status'))
                            ...
                            @php $mellatInfo = json_decode(@$mellat->information, true); @endphp
                            ...
                            <div class="form-group">
                                <label>{{ __('Callback URL') }}</label>
                                <input type="text" class="form-control" name="callback_url"
                                    value="{{ @$mellatInfo['callback_url'] ?? url('mellat/success') }}" readonly>
                                <p class="text-warning mt-1 mb-0">
                                    {{ __('Set this URL in your Bank Mellat dashboard.') }}
                                </p>
                            </div>
                        </div>
                    </div>

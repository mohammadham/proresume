                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="analytics_status" value="1"
                                                ...
                                                {{ $data->analytics_status == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Active') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="analytics_status" value="0"
                                                class="selectgroup-input"
                                                {{ $data->analytics_status == 0 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Deactive') }}</span>
                                        </label>
                                    </div>
                                    @if ($errors->has('analytics_status'))
                                        <p class="mb-0 text-danger">{{ $errors->first('analytics_status') }}</p>
                                    @endif
                                </div>
                                <div class="form-group">
                                    <label>{{ __('Measurement ID') }}</label>
                                    <input class="form-control" name="measurement_id" value="{{ $data->measurement_id }}">
                                    @if ($errors->has('measurement_id'))
                                        <p class="mb-0 text-danger">{{ $errors->first('measurement_id') }}</p>
                                    @endif
                                </div>

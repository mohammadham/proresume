                ...
                <form action="{{ route('admin.seo.update', ['language' => request()->input('language')]) }}" method="post">
                    ...
                    <div class="card-body pt-5 pb-5">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>{{ __('Meta Keywords For Vcards Page') }}</label>
                                    <input class="form-control" name="vcard_meta_keywords"
                                        value="{{ $data->vcard_meta_keywords }}"
                                        placeholder="{{ __('Enter Meta Keywords') }}" data-role="tagsinput">
                                </div>

                                <div class="form-group">
                                    <label>{{ __('Meta Description For Vcards Page') }}</label>
                                    <textarea class="form-control" name="vcard_meta_description" rows="5"
                                        placeholder="{{ __('Enter Meta Description') }}">{{ $data->vcard_meta_description }}</textarea>
                                </div>
                            </div>

                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>{{ __('Meta Keywords For Templates Page') }}</label>
                                    <input class="form-control" name="templates_meta_keywords"
                                        value="{{ $data->templates_meta_keywords }}"
                                        placeholder="{{ __('Enter Meta Keywords') }}" data-role="tagsinput">
                                </div>

                                <div class="form-group">
                                    <label>{{ __('Meta Description For Templates Page') }}</label>
                                    <textarea class="form-control" name="templates_meta_description" rows="5"
                                        placeholder="{{ __('Enter Meta Description') }}">{{ $data->templates_meta_description }}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>{{ __('Meta Keywords For Cv Page') }}</label>
                                    <input class="form-control" name="cv_meta_keywords"
                                        value="{{ $data->cv_meta_keywords }}"
                                        placeholder="{{ __('Enter Meta Keywords') }}" data-role="tagsinput">
                                </div>

                                <div class="form-group">
                                    <label>{{ __('Meta Description For Cv Page') }}</label>
                                    <textarea class="form-control" name="cv_meta_description" rows="5"
                                        placeholder="{{ __('Enter Meta Description') }}">{{ $data->cv_meta_description }}</textarea>
                                </div>
                            </div>
                        </div>

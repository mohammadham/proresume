                            ...
                            <form id="ajaxForm" class="" action="{{ route('user.portfolio.update') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title"
                                        value="{{ $portfolio->title }}" placeholder="{{ __('Enter title') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control summernote" name="content" data-height="300" placeholder="{{ __('Enter content') }}">{{ replaceBaseUrl($portfolio->content) }}</textarea>
                                ...
                                @if ($userBs->theme != 10 && $userBs->theme != 11)
                                    <div class="form-group">
    ...
    <script>
        ...
        Dropzone.options.myDropzone = {
            ...
            success: function(file, response) {
                ...
                content.message = "{{ __('Slider image uploaded successfully!') }}";
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data == "minimum_one") {
                        ...
                        content.message = "{{ __('Minimum one slider image is required!') }}";
                        ...
                        content.message = "{{ __('Slider image deleted successfully!') }}";
                        content.title = "{{ __('Success') }}";
                        content.icon = 'fa fa-bell';

                        ...
                        @foreach ($blogs as $blog)
                            <div class="col-lg-6 col-sm-12">
                                <div class="blog-item mb-50">
                                    <div class="post-img">
                                        <a
                                            href="{{ route('front.user.blog.detail', [getParam(), $blog->slug, $blog->id]) }}"><img
                                    ...
                                    <div class="entry-content">
                                        ...
                                        <h3 class="title"><a
                                                href="{{ route('front.user.blog.detail', [getParam(), $blog->slug, $blog->id]) }}">{{ strlen($blog->title) > 50 ? mb_substr($blog->title, 0, 50, 'UTF-8') . '...' : $blog->title }}</a>
                                        </h3>
                                    </div>
                                </div>
                            </div>

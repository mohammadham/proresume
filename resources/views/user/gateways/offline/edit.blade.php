    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Edit Gateway') }}
                </h5>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <p class="text-warning">
                                    <small>{{ __('The higher the serial number is, the later the gateway will be shown everywhere') . '.'}}</small>
                                </p>
                            </div>
                        </div>
                    </div>

        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card-title d-inline-block">{{ __('Testimonials') }}
                            </div>
                        </div>
                        <div class="col-lg-3">
                    ...
                    <form id="ajaxForm" enctype="multipart/form-data" class="modal-form"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="occupation"
                                placeholder="{{ __('Enter occupation') }}" value="">
                            <p id="erroccupation" class="mb-0 text-danger em"></p>
                        </div>
                        <div class="form-group">
                            <label for="">{{ __('Feedback') }} **</label>
                            <textarea class="form-control" name="content" rows="5" placeholder="{{ __('Enter Feedback') }}"></textarea>
                        ...
                        @if ($userBs->theme == 12)
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control" name="rate"
                                    placeholder="{{ __('Enter rating') }}" value="">

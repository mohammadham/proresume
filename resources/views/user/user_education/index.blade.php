...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ __('Educations') }}</h4>
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">{{ __('Educations Page') }}</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
            <li class="nav-item">
                <a href="#">{{ __('Educations') }}</a>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card-title d-inline-block">{{ __('Educations') }}</div>
                        </div>
                        <div class="col-lg-3">
                                        ...
                                        <table class="table table-striped mt-3" id="basic-datatables">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">{{ __('Degree Name') }}
                                                    </th>
                                                    <th scope="col">{{ __('Start Date') }}
                                                    </th>
                ...
                <div class="modal-body">
                    <form id="ajaxForm" enctype="multipart/form-data" class="modal-form"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="">{{ __('Degree Name') }} **</label>
                                    <input type="text" class="form-control" name="degree_name"
                                        placeholder="{{ __('Enter degree name') }}"
                                        value="">
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-warning mb-0">
                                <small>{{  __('The higher the serial number is, the later the experience will be shown') . '.' }}</small>
                            </p>
                        </div>
                    </form>
                </div>

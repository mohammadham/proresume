                                ...
                                <div class="form-group">
                                    <div class="selectgroup selectgroup-pills mt-2 justify-content-center">
                                        <label class="selectgroup-item">
                                            ...
                                            <span
                                                class="selectgroup-button">{{ __('Call Button') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            ...
                                            <span
                                                class="selectgroup-button">{{ __('Whatsapp Button') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            ...
                                            <span
                                                class="selectgroup-button">{{ __('Mail Button') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            ...
                                            <span
                                                class="selectgroup-button">{{ __("'Add to Contact' Button") }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            ...
                                            <span
                                                class="selectgroup-button">{{ __("'Share vCard' Button") }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            ...
                                            <span
                                                class="selectgroup-button">{{ __('Information Section') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            ...
                                            <span
                                                class="selectgroup-button">{{ __('Video Section') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            ...
                                            <span
                                                class="selectgroup-button">{{  __('About Us Section') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            ...
                                            <span
                                                class="selectgroup-button">{{  __('Services Section') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            ...
                                            <span
                                                class="selectgroup-button">{{  __('Projects Section') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            ...
                                            <span
                                                class="selectgroup-button">{{ __('Testimonials Section') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            ...
                                            <span
                                                class="selectgroup-button">{{ __('Enquiry Form Section') }}</span>
                                        </label>
                                    </div>
                                </div>
                            </form>

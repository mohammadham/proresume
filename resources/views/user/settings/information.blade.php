            ...
            <div class="card">
                <form id="ajaxForm" action="{{ route('user.basic_settings.update_info') }}" method="post">
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-10">
                                <div class="card-title">{{  __('Update Information') }}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 offset-lg-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>{{ __('Base Currency Text Position') }}
                                                **</label>

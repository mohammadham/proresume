                ...
                <div class="card">
                    <form action="{{ route('user.update_analytics') }}" method="post">
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card-title">{{ __('Google Analytics') }}
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p class="text-warning mb-0">
                                            {{ __('Phone Code must be included in Phone Number') }}
                                        </p>
                                    ...
                                    <div class="form-group">
                                        <label>{{ __('WhatsApp Header Title') }}
                                            *</label>
                                    ...
                                    <div class="form-group">
                                        <label>{{ __('WhatsApp Popup Status') }}
                                            *</label>
                                        <div class="selectgroup w-100">
                                            <label class="selectgroup-item">
                                    ...
                                    <div class="form-group">
                                        <label>{{ __('WhatsApp Popup Message') }}
                                            *</label>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <p class="text text-warning">
                                            <strong>{{ __('Hint') }}:</strong> <a
                                                class="text-primary" href="https://prnt.sc/5u1ZP6YjAw5O"
                                                target="_blank">{{ __('Click Here to see where to get the Facebook Pixel ID') }}</a>
                                        </p>

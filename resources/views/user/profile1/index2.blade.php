...
@section('content')
            ...
            <div class="row align-items-center justify-content-lg-between justify-content-center">
                ...
                <div class="col-lg-6 order-lg-first col-md-9">
                    <div class="skill-content pr-0 pr-lg-4">
                        <div class="common-heading mb-30">
                            <span class="tagline-two">{{$home_text->skills_title ?? $keywords['Skills']}}</span>
    ...
    <section class="service-section section-gap bg-offwhite-color" id="service">
        <div class="container">
            <div class="common-heading text-center mb-20">
                <span class="tagline-two">{{$home_text->service_title ?? $keywords['Services']}}</span>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-9">
                    <div class="common-heading text-center mb-60">
                        <span class="tagline-two">{{$home_text->experience_title ?? $keywords['Experience']}}</span>
                        <h2 class="title">{{$home_text->experience_subtitle ?? $keywords['Experience']}}</h2>
                    </div>
                </div>
            </div>
    ...
    <section class="portfolio-section section-gap" id="portfolio">
        <div class="container">
            <div class="common-heading text-center mb-50">
                <span class="tagline-two">{{$home_text->portfolio_title ?? $keywords['Portfolios']}}</span>
                <h2 class="title">{{$home_text->portfolio_subtitle ??  $keywords['Portfolios']}}</h2>
            </div>
    ...
    <section class="testimonial-section section-gap bg-offwhite-color">
        <div class="container">
            <div class="common-heading text-center mb-50">
                <span class="tagline-two">{{$home_text->testimonial_title ?? $keywords['Testimonials']}}</span>
                <h2 class="title">{{$home_text->testimonial_subtitle ?? $keywords['Testimonials']}}</h2>
            </div>
    ...
    <section class="latest-blog-section section-gap" id="blog">
        <div class="container">
            <div class="common-heading text-center mb-20">
                <span class="tagline-two">{{$home_text->blog_title ?? $keywords['Blogs']}}</span>
                <h2 class="title">{{$home_text->blog_subtitle ?? $keywords['Blogs']}}</h2>
            </div>
            <div class="row justify-content-center">
    ...
    <section class="contact-section bg-offwhite-color section-gap" id="contact">
        <div class="container">
            <div class="common-heading text-center mb-50">
                <span class="tagline-two">{{$home_text->contact_title ??  $keywords['Get in touch']}}</span>
                <h2 class="title">{{$home_text->contact_subtitle ?? $keywords['Get in touch']}}</h2>
            </div>

...
@section('content')
                ...
                <div class="col-lg-6 col-md-10">
                    <div class="about-text">
                        <div class="section-heading mb-25">
                            <span class="tagline">{{ $home_text->about_title ?? $keywords['My Resume'] }}</span>
                            <h2 class="title">
                                {{ $home_text->about_subtitle ?? $keywords['About Me'] }}
                            </h2>
                        </div>
        ...
        <section class="skill-section lazy" data-bg="{{ asset('assets/front/css/profile/theme6-8/skill-bg.jpg') }}">
            <div class="container">
                <div class="section-heading heading-white text-center text-xl-center mb-15">
                    <span class="tagline">{{ $home_text->skills_subtitle ?? $keywords['Skills'] }}</span>
                    <h2 class="title">{{ $home_text->skills_subtitle ?? $keywords['Technical Skills'] }}</h2>
                </div>
        ...
        <section class="service-section section-gap bg-grey-color" id="services">
            <div class="container">
                <div class="section-heading text-center mb-20">
                    <span class="tagline">{{ $home_text->service_title ?? $keywords['Services'] }}</span>
                    <h2 class="title">{{ $home_text->service_subtitle ?? $keywords['What I Do'] . '?' }}</h2>
                </div>
        ...
        <section class="resume-section section-gap">
            <div class="container">
                <div class="section-heading text-center mb-50">
                    <div class="tagline">
                        {{ !empty($home_text->experience_title) ? $home_text->experience_title : $keywords['My Resume'] }}
                    </div>
                    <h2 class="title">
                        {{ !empty($home_text->experience_subtitle) ? $home_text->experience_subtitle : $keywords['Experience'] }}
                    </h2>
                </div>
        ...
        <section class="project-section section-gap">
            <div class="container">
                <div class="section-heading text-center mb-40">
                    <span
                        class="tagline">{{ !empty($home_text->portfolio_title) ? $home_text->portfolio_title : $keywords['Portfolios'] }}</span>
                    <h2 class="title">
                        {{ !empty($home_text->portfolio_subtitle) ? $home_text->portfolio_subtitle : $keywords['Portfolios'] }}
                    </h2>
                </div>
        ...
        <section class="testimonial-section">
            <div class="container">
                <div class="section-heading mb-50">
                    <span
                        class="tagline">{{ !empty($home_text->testimonial_title) ? $home_text->testimonial_title : $keywords['Testimonials'] }}</span>
                    <h2 class="title">
                        {{ !empty($home_text->testimonial_subtitle) ? $home_text->testimonial_subtitle : $keywords['Testimonials'] }}
                    </h2>
                </div>
    ...
    @if (is_array($userPermissions) && in_array('Testimonial', $userPermissions))
        ...
        <section class="blog-section section-gap">
            <div class="container">
                <div class="section-heading text-center mb-20">
                    <span
                        class="tagline">{{ !empty($home_text->blog_title) ? $home_text->blog_title : $keywords['Blogs'] }}</span>
                    <h2 class="title">
                        {{ !empty($home_text->blog_subtitle) ? $home_text->blog_subtitle : $keywords['Blogs'] }}
                    </h2>
                </div>
    ...
    <section class="contact-section section-gap-bottom">
        <div class="container">
            <div class="section-heading text-center mb-50">
                <span
                    class="tagline">{{ !empty($home_text->contact_title) ? $home_text->contact_title : $keywords['Get in touch'] }}</span>
                <h2 class="title">
                    {{ !empty($home_text->contact_subtitle) ? $home_text->contact_subtitle : $keywords['Get in touch'] }}
                </h2>
            </div>

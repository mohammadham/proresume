                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 text-right">
                        <a class="btn btn-primary"
                            href="{{ route('user.forminput', ['id' => $input->category_id]) . '?language=' . request()->input('language') }}">{{ __('Back') }}</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row" id="app">
                ...
                <div class="col-lg-6 offset-lg-3">
                    <form id="ajaxForm" action="{{ route('user.form.inputUpdate') }}" method="post"
                        ...
                        <div class="form-group">
                            <label
                                for=""><strong>{{ __('Label Name') }}</strong></label>
                            <div class="">
                        ...
                        @if ($input->type != 3 && $input->type != 5)
                            <div class="form-group">
                                <label
                                    for=""><strong>{{ __('Placeholder') }}</strong></label>
                                <div class="">
                        ...
                        <div class="text-center form-group">
                            <button id="" data-form="ajaxForm" type="submit"
                                class="submitBtn btn btn-primary">{{ __('UPDATE FIELD') }}</button>
                        </div>
                    </form>
                </div>
            </div>

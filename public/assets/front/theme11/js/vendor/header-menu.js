(function ($) {
  ...
  /*-------- MainMenu & MainMenu2 to MobileMenu --------*/
  const mainMenu = document.querySelector('#mainMenu');
  const mainMenu2 = document.querySelector('#mainMenu2');
  const mobileMenu = document.querySelector('#mobileMenu');
  ...
  if (mobileMenu) {
    if (mainMenu) {
      const cloneMenu1 = mainMenu.cloneNode(true);
      mobileMenu.appendChild(cloneMenu1);
    }

    if (mainMenu2) {
      const cloneMenu2 = mainMenu2.cloneNode(true);
      mobileMenu.appendChild(cloneMenu2);
    }
  }
